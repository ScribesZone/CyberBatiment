...
#. - le serveur de contrôle devra être développé impérativement en JAVA
#. - les autres parties devront être développées en Python 3.5.
...
#. JAVA est le langage usuel de programmation des contrôleurs chez BATEMIS.
...
#. Pour initialiser le développement de l’ERP CyberBatiment, il a été décidé de développer une première version pour l'usine Chimiotis à Morrocoy (Venezuala), qui requiert les fonctionnalités les plus courantes,
...
#. La prochaine réunion aura lieu à Morrocoy en présence de Competis.
