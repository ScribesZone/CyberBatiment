...
#. En fait les bissas sont entièrement contrôlés par le driver fourni par AccessIT.
...
#. AccessIT propose deux types de bissas, les bissas Astra et les bissas Xtra.
...
#. AccessIT propose aussi des bissas haute sécurité, les bissas Xtra.
