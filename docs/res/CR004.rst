...
#. Il a été convenu que l'IM2AG fournirait rapidement des scénarios qui serviront à écrire les tests de la version du KIS.
...
#. Cependant pour des raisons de délai, les caméras ne seront pas connectées à iAccess pour le KIS
