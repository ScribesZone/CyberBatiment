...
#. Les applis des phablettes gardiens seront connectés au serveur applicatif via une connexion sécurisée https et un réseau wifi interne sécurisé.
...
#. Evidemment si nécessaire les gardiens peuvent utiliser la fonction téléphone de leur phablette pour appeler les services compétents (urgences, police, armée, etc.)
